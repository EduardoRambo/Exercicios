public class Aluno {
    ...
    public String verificarAprovacão() {
        if (this.calcularMediaAritmetica() >= 0 && this.calcularMediaAritmetica() <= 5.9) {
            return "Nota D - Reprovado";
        } else  
        if (this.calcularMediaAritmetica() >= 6 && this.calcularMediaAritmetica() <= 6.9) {
            return "Nota C - Aprovado";
        } else 
        if (this.calcularMediaAritmetica() >= 7 && this.calcularMediaAritmetica() <= 8.9) {
            return "Nota B - Aprovado";
        } else 
            return "Nota A - Aprovado";
}

    public String verificarAprovacãoComFrequencia() {
    ...
    public String toString() {
        return "\nNome: " + this.nome
             ...
             + "\nAprovação por nota: " + this.verificarAprovacão();
    }
}
